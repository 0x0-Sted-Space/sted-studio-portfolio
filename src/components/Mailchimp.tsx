        ...
        <Flex
            ...
            <style>{`
                @media (max-width: 600px) {
                    ...
                    .newsletter-flex-mobile {
                        flex-direction: column !important;
                        align-items: center !important;
                        width: 100% !important;
                    }
                    .newsletter-form .newsletter-input,
                    .newsletter-flex-mobile .newsletter-input {
                        width: 100% !important;
                        min-width: 0 !important;
                        margin-bottom: 10px !important;
                    }
                    .newsletter-form .newsletter-button,
                    .newsletter-flex-mobile .newsletter-button {
                        width: 100% !important;
                        min-width: 0 !important;
                    }
                }
            ...
            <form
                ...
                <Flex id="mc_embed_signup_scroll"
                    className="newsletter-flex-mobile"
                ...
                >
                    ...
                    <div className="clear" style={{ width: '100%' }}>
                        <Flex height="48" alignItems="center" style={{ width: '100%' }}>
                            <Button
